 ...
 * 
 * <pre>
 * String sql = new SelectBuilder(&quot;Employee e&quot;).column(&quot;e.id&quot;)
 * 		.column(&quot;e.name as empname&quot;).column(&quot;d.name as deptname&quot;)
 * 		.column(&quot;e.salary&quot;).join(&quot;Department d on e.dept_id = d.id&quot;)
 * 		.where(&quot;e.salary &gt; 100000&quot;).orderBy(&quot;e.salary desc&quot;).toString();
 * </pre>
 * 
 * <pre>
 * String sql = new SelectBuilder(&quot;Department d&quot;).column(&quot;d.id&quot;).column(&quot;d.name&quot;)
 * 		.column(&quot;sum(e.salary) as total&quot;)
 * 		.join(&quot;Employee e on e.dept_id = d.id&quot;).groupBy(&quot;d.id&quot;)
 * 		.groupBy(&quot;d.name&quot;).having(&quot;total &gt; 1000000&quot;).toString();
 * </pre>
 * 
 ...
 * 
 * <pre>
 * select.addCriteria(new MatchCriteria(orders, &quot;status&quot;, MatchCriteria.EQUALS,
 * 		&quot;processed&quot;));
 * </pre>
 * 
 ...
 * 
 * <pre>
 * String sql = new SelectBuilder(&quot;Employee e&quot;).where(&quot;name like :name&quot;)
 * 		.toString();
 * 
 * PreparedStatement ps = new ParameterizedPreparedStatementCreator(sql)
 * 		.setParameter(&quot;name&quot;, &quot;Bob%&quot;).createPreparedStatement(conn);
 * </pre>
 * 
 * 
*
	...
	public SelectBuilder noWait() {
		if (!forUpdate) {
			throw new RuntimeException(
					"noWait without forUpdate cannot be called");
		}
		noWait = true;
		return this;
	}
